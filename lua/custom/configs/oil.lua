...
local icons = require("custom.static").icons
  ...
  keymaps = {
    ...
    ["<C-o>"] = { -- Prevent jumping to file buffers by accident
      ...
      callback = function()
        ...
        return prevloc and vim.api.nvim_buf_is_valid(prevloc.bufnr) and vim.bo[prevloc.bufnr].ft == "oil" and "<C-o>"
          or "<Ignore>"
      end,
    },
    ["<C-i>"] = {
      ...
      callback = function()
        ...
        return newloc and vim.api.nvim_buf_is_valid(newloc.bufnr) and vim.bo[newloc.bufnr].ft == "oil" and "<C-i>"
          or "<Ignore>"
      end,
    },
  },
