local sethl_groups = require("utils.general").sethl_groups
local hl = require "utils.general"
local gethl = hl.gethl

local hlgroups = {
  -- UI
  WinSeparator = { link = "Number" },
  ...
  -- Noice
  NoiceCmdlinePopupBorder = { link = "EndOfBuffer" },
  NoiceCmdlinePopupTitle = { link = "LineNr" },
  NoiceCmdlineIcon = { link = "ErrorMsg" },
  NoiceCmdlinePopup = { link = "Comment" },
